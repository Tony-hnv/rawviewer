...
当前开发版本为 **1.1.5**，Android `versionCode` 为 **16**。此版本支持单选、多选、当前筛选全选后安全清除本地副本；同时修复边框拉伸，改用保持比例的上图下信息栏布局，并为品牌模板添加相机/手机类别图标与字母徽章；尚未自动推送或发布新的 GitHub Release。
