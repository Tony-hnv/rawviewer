...
| 比例裁切   | 支持将 PNG、JPG、JPEG 从中心裁切为 1:1、4:3、3:4、16:9 或 9:16，并保存为新副本。           |
...
在详情页点击“按比例裁切”，选择 `1:1`、`4:3`、`3:4`、`16:9` 或 `9:16`。当前实现按图片中心计算裁切区域，并把结果保存为新的应用本地副本，不会改动原图或原始导入文件。为保留 RAW 原始数据，裁切仅适用于 PNG、JPG 和 JPEG；RAW 文件会给出明确提示。
...
当前发布版本为 **1.1.0**，Android `versionCode` 为 **11**。
...
| 比例裁切   | 当前为简洁的居中裁切，尚不支持自由拖动裁切框；裁切 RAW 需先导出或转换为普通图片。         |
